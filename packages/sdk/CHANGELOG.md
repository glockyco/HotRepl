...
- [`03f4cb2`](https://github.com/glockyco/HotRepl/commit/03f4cb2b36cb487005e7974a57c27261dc42db2b)
  Thanks [@glockyco](https://github.com/glockyco)! - Deliver command artifacts as files a client can
  read.
  ...
  The clients no longer corrupt or hide what they read. `WebSocketTransport` reads a `file:` URI,
  uses `node:fs` instead of Bun-only APIs, and reports an unreadable scheme as
