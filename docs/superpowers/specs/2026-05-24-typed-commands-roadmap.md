...
| **2. Ardenfall**        | Migrate Ardenfall's ~10 typed commands to the new interface. Simplest real consumer (Mono, no jobs, no IL2CPP). Fastest design-validation loop.                                                                                                                                                                   | [`2026-05-24-typed-commands-phase-2-ardenfall-migration.md`](2026-05-24-typed-commands-phase-2-ardenfall-migration.md) |
